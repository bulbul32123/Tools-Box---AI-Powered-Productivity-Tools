...
export default function TextConverterPage() {
  ...
  const outputFormats = [
    ...
    { value: "md", label: "Markdown", description: "Markdown Format" },
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/file/convert/txt", {
        method: "POST",
        body: formData,
      })
  ...
  const handleDownload = () => {
    ...
    const extension = outputFormats.find((f) => f.value === outputFormat)?.value || "pdf"
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-balance">Text Converter</h1>
              <p className="text-muted-foreground text-pretty">Convert text files between formats</p>
            </div>
          </div>
        </div>
        ...
        <FileUpload
          ...
          acceptedFormats={["text/plain", ".txt", ".md", ".csv", ".log"]}
          title="Upload a text file"
          description="Drag and drop your text document or click to browse"
        />
