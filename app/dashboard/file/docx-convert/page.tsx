...
export default function DOCXConverterPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/file/convert/docx", {
        method: "POST",
        body: formData,
      })
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-balance">DOCX Converter</h1>
              <p className="text-muted-foreground text-pretty">Convert DOCX files to PDF, TXT, and more</p>
            </div>
          </div>
        </div>
        ...
        <FileUpload
          ...
          description="Drag and drop your Word document or click to browse"
        />
